        ...
        while (true) {
            try {
                switch (change) {
                    case 1:
                        if (!super.isReverse()) {
                            for (int i = super.getY(); i < 500; i = i + 15) {//´+30
                                for (int j = 3; j < 6; j++) {
                    ...
                    case 2:
                        if (!super.isReverse()) {
                            for (int i = super.getX(); i > 175; i = i - 15) {//-15
                                for (int j = 3; j < 6; j++) {
                                    super.setImage(sprite.get(j));
                                    Thread.sleep(100);
                                }
                    ...
                    case 4:
                        ...
                        if (!super.isReverse()) {
                            for (int i = super.getY(); i > 2; i = i - 15) {//-20
                                for (int j = 0; j < 3; j++) {
                                    super.setImage(sprite.get(j));
                                    Thread.sleep(100);
                                }
                            ...
                            for (int i = super.getY(); i < 500; i = i + 15) {//+45
                                for (int j = 0; j < 3; j++) {
                                    super.setImage(sprite.get(j));
                                    Thread.sleep(100);
                                }
                    ...
                    case 5:
                        if (!super.isReverse()) {
                            for (int i = super.getX(); i < 730; i = i + 15) {//+10
                                for (int j = 0; j < 3; j++) {
                                    super.setImage(sprite.get(j));
                                    Thread.sleep(100);
                                }
