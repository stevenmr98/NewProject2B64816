        ...
        while (true) {
            try {
                switch (change) {
                    case 1:
                        if (!super.isReverse()) {
                            for (int i = super.getY(); i < 510; i = i + 15) {//´+30
                                for (int j = 3; j < 6; j++) {
                                    super.setImage(sprite.get(j));
                                    Thread.sleep(this.getSpeed());
                                }
                                super.setY(i);
                                if (super.getY() > 255 && super.getY() < 470) {
                    ...
                    case 2:
                        if (!super.isReverse()) {
                            for (int i = super.getX(); i > 159; i = i - 15) {//-15
                                for (int j = 3; j < 6; j++) {
                                    super.setImage(sprite.get(j));
                                    Thread.sleep(100);
                                }
                    ...
                    case 4:
                        ...
                        if (!super.isReverse()) {
                            ...
                            for (int i = super.getY(); i < 510; i = i + 15) {//+45
                                for (int j = 0; j < 3; j++) {
                                    super.setImage(sprite.get(j));
                                    Thread.sleep(100);
                                }
                    ...
                    case 5:
                        if (!super.isReverse()) {
                            for (int i = super.getX(); i < 770; i = i + 15) {//+10
                                for (int j = 0; j < 3; j++) {
                                    super.setImage(sprite.get(j));
                                    Thread.sleep(100);
                                }
                    ...
                    case 6:
                        if (!super.isReverse()) {
                            for (int i = super.getY(); i < 250; i = i + 15) {//+10
                                for (int j = 3; j < 6; j++) {
                                    super.setImage(sprite.get(j));
                                    Thread.sleep(100);
                                }
